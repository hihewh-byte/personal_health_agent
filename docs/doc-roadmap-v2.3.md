...
> **修订日期**：2026-06-01  
> **当前 build**：`pha-v2.3.18-wave3d-gamma-wearable-soul-align`
...
| **D-3d-2** | [`stage3d-wearable-e2e-checklist.md`](stage3d-wearable-e2e-checklist.md) | 6 图 + 无图追问 + **G-Compare / G-Interp / G-Delta** | D-3d-γ | 📝 待写 |
| **D-4a-1** | [`wave4a-open-source-readiness-spec.md`](wave4a-open-source-readiness-spec.md) | 开源边界、PII、CI、doctor、LICENSE | PM 裁定 | 📝 待写 |
...
| **D-4b-1** | `wave4b-chronic-health-brief-spec.md` | L1.5 CHB Schema、Compiler、写盘门禁 | 3d E2E 绿灯 | 📝 待写 |
...
| ID | 任务 | 类型 | 绑定文档 | 状态 |
|----|------|------|----------|------|
| **C-1** | 真机：新会话 6 图 E2E | 验收 | D-3d-2 E1 | ⏳ |
| **C-2** | 真机：无图追问 E2E | 验收 | D-3d-2 E2-E3 | ⏳ |
| **C-3** | `scripts/pha_e2e_wearable_screens_real.py` | 编码 | D-3d-β | 📋 |
| **C-4** | F 层 `apple_health_screens_6panel` synthetic | 编码 | D-3d-β | 📋 |
| **C-5** | `pyproject.toml` + `pha doctor` CLI | 编码 | D-4a-1 | 📋 |
| **C-6** | `.github/workflows/ci.yml` mock selfcheck | 编码 | D-4a-1 | 📋 |
...
| **C-20** | 对话 metric 探针 + `GET /api/wearable/metric-probe` | 编码 | C-17 | ✅ v2.3.28 |
...
| **W-2** | 完成 D-3d-2 红绿表（含 G-Compare） | P0 | 🚧 见 [`stage3d-wearable-pre-e2e-gate.md`](stage3d-wearable-pre-e2e-gate.md) |
| **W-9** | 完成 D-3d-γ Spec 评审 → v1.0 | P0 | ✅ v1.0 已签字 |
| **W-10** | D-3d-ε / D-3d-δ Spec 签字 | P0 | ✅ v1.0 |
| **W-3** | 完成 D-4a-1 全文 | P0 | 📋 |
| **W-4** | 更新 stage3c-wearable §10/§12 | P0 | 📋 |
| **W-5** | 完成 D-4b-1 全文 | P1 | 🔒 等 3d 绿灯 |
| **W-6** | 完成 D-3d-β Spec | P1 | 📋 |
| **W-7** | English README + CONTRIBUTING | P1 | 📋 |
| **W-8** | D-4c-1 跨平台矩阵 | P2 | 📋 |
...
Wave 3d-γ ✅ ──► stage3d-gamma-wearable-compare-contract-spec.md (W-9)
              ...
              真机 C-1/C-2 ⏳ · DeepSeek Compare Audit 已通过 (v2.3.18)
